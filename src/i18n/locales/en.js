export default {
  ...
  REGISTER: {
    ...
    bio: 'Tell employers about yourself...',
  ...
  EDIT_PROFILE: {
    ...
    wantToEditProfile: 'Update profile?',
  ...
  USER_DOCUMENTS: {
    ...
    notVerifyInfo:
      'Employers require your employment verification, please complete these 5 steps to get verified and receive more job invites:',
  ...
  JOB_PREFERENCES: {
    ...
    editJobPreferences: 'Update job preferences?',
  ...
  DASHBOARD: {
    ...
    myRating: 'My rating',
    stopReceivingInvites: 'Receive Auto Invites',
    y: 'Y',
    n: 'N',
  },
  PROFILE: {
